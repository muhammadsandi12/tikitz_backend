...
module.exports = {
    get: (req, res)=> {
      return new Promise((resolve, reject)=> {
        ...
        const {title, director} = req.params
        ...
        // const sql = `SELECT categories.genre FROM movies INNER JOIN categories ON categories.id = movies.id_categories `
